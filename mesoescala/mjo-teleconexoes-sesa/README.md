...
7. **MJO no Contexto Global:** Padrão tropical de dipolos de convecção ativa (anomalia de precipitação/convecção em verde) e convecção suprimida (marrom) para todas as 8 fases segundo as composições NOAA CPC / Wheeler & Hendon, acompanhado da trilha equatorial numerada de 1 a 8 com seleção interativa por clique direto no mapa.
