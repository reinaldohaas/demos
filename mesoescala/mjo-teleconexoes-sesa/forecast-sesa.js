...
(() => {
  ...
  const periods = [
    ...
    ,{title:'Dias 31–45 · 25/10–08/11/2026', text:'Sem síntese regional verificada para esta janela. O ECMWF disponibiliza previsões subsezonais com horizonte de até 46 dias; abra o produto oficial da América do Sul e confira a emissão e as semanas efetivamente disponíveis. Nenhum sinal de chuva ou fase futura da MJO foi extrapolado nesta demonstração.', source:'https://charts.ecmwf.int/products/extended-anomaly-tp?projection=opencharts_south_america', images:[], caption:'Período sem mapa incorporado e sem estimativa regional nesta página. Horizonte do sistema não garante habilidade de previsão no SESA. A janela é contada a partir do boletim de 25/09, não da data de abertura da página.'}
  ];
  let selected = 0, currentSpeech = '', voiceEnabled = false;
  panel.innerHTML = `<h2>SESA · boletim e horizonte de 45 dias</h2>
    <p><strong>Boletim consultado em 25/09/2026 · horizonte de 45 dias: 25/09–08/11/2026</strong></p>
    <p id="forecastAge" role="status"></p>
    <p><strong>Cobertura:</strong> GFS nas duas primeiras semanas; CFSv2 nas semanas 3–4. A extensão até 45 dias está disponível para consulta, mas permanece sem síntese regional verificada. Datas referem-se ao boletim indicado, não a uma atualização automática.</p>
    <p><a href="https://www.ecmwf.int/en/forecasts/charts" target="_blank" rel="noopener">ECMWF: produtos subsezonais até 46 dias</a> · <a href="https://charts.ecmwf.int/products/extended-anomaly-tp?projection=opencharts_south_america" target="_blank" rel="noopener">Anomalias semanais de precipitação — América do Sul</a></p>
